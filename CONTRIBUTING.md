...
Maverick is a clean-slate rebuild. Contributions should make the platform easier to read, test, delete, and secure.
...
- Do not introduce compatibility shims for obsolete APIs.
