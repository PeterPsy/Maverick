...
- **Remote agentic containment:** Google, OpenRouter, and any other hosted agentic runtime are Phase-0 **NO-GO** and fail closed before persistence and dispatch. Their certification manifests execute fixture contracts only; this repository does not claim an operational apply, live-provider probe, or completed remote release gate. Exact Codex agentic and `plain_hosted_chat` behavior remain separate.
