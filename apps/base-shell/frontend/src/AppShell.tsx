...
export function AppShell() {
  ...
  const initialActiveAppId = useMemo(
    () => initialRoute.appId || (window.location.pathname === "/" ? null : initialSession.activeAppId),
    [initialRoute.appId, initialSession.activeAppId],
  );
