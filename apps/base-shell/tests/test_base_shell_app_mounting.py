...
class BaseShellAppMountingTests(unittest.TestCase):
    def test_base_shell_apps_route_defaults_to_app_store(self) -> None:
        ...
        self.assertIn("initialRoute.appId || initialSession.activeAppId", shell_source)
    ...
    def test_sidebar_uses_chat_widget_and_app_store_pinned_rail(self) -> None:
        ...
        self.assertIn('sidebarMode: "rail"', session_source)
        self.assertIn('size?: "compact" | "fill" | "overlay"', (REPO_ROOT / "apps/base-shell/frontend/src/components/WidgetSlot.tsx").read_text())
    ...
    def test_chat_creation_starts_runtime_session_immediately(self) -> None:
        ...
        self.assertIn("onRuntimeSnapshot: () => setIsHistoryLoading(false)", chat_source)
        ...
        self.assertIn("DeleteChatsDialog", chat_source)
    ...
    def test_chat_floating_widget_uses_chat_owned_surfaces(self) -> None:
        ...
        self.assertIn('debugThreadSync("active-thread-changed"', widget_source)
