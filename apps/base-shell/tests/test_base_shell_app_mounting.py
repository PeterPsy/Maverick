...
class BaseShellAppMountingTests(unittest.TestCase):
    def test_base_shell_apps_route_defaults_to_app_store(self) -> None:
        ...
        self.assertIn("activeAppId: null", session_source)
        ...
        self.assertIn('window.location.pathname === "/" ? null : initialSession.activeAppId', shell_source)
        self.assertIn("setActiveAppId(null)", shell_source)
        self.assertIn("pushShellAppRoute(null, {})", shell_source)
        self.assertIn("replaceShellAppRoute(null, {})", shell_source)
        self.assertNotIn('app.app_id === "app-store"', shell_source)
        self.assertIn('activeAppId === null ? "is-active" : ""', sidebar_source)
    ...
    def test_sidebar_uses_app_store_widget_instead_of_local_pins(self) -> None:
        ...
        self.assertNotIn('contentKind="shell.sidebar.primary"', sidebar_source)
        self.assertNotIn('size="compact"', sidebar_source)
        self.assertIn('size?: "fill" | "overlay"', (REPO_ROOT / "apps/base-shell/frontend/src/components/WidgetSlot.tsx").read_text())
