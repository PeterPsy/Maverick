...
class BaseShellAppMountingTests(unittest.TestCase):
    ...
    def test_sidebar_uses_chat_widget_and_app_store_pinned_rail(self) -> None:
        ...
        self.assertIn('isEdgeCollapsed = mode === "rail" && !isDetailLayerOpen && !isMobileLayout', sidebar_source)
        self.assertIn('className="bs-sidebar__edge-tab"', sidebar_source)
        self.assertIn('aria-label="Open side menu"', sidebar_source)
        self.assertIn("is-edge-collapsed", sidebar_styles)
        self.assertIn(".bs-sidebar__edge-tab", sidebar_styles)
        self.assertIn(".bs-sidebar--rail.is-closed.is-edge-collapsed:hover .bs-sidebar__edge-tab", sidebar_styles)
    ...
    def test_chat_floating_widget_uses_chat_owned_surfaces(self) -> None:
        ...
        self.assertIn('aria-label={isActiveThreadBusy ? "Open active chat" : "Open chat"}', widget_source)
