...
class BuiltinAppsTestCase(unittest.TestCase):
    ...
    def test_platform_host_serves_root_shell_pwa_assets_without_session(self) -> None:
        ...
        status_offline, offline_body, offline_headers = self.invoke(app, path="/offline.html")
        ...
        self.assertEqual(status_offline, 200)
        ...
        self.assertEqual(offline_headers["Cache-Control"], "no-store")
        ...
        self.assertEqual(offline_headers["Access-Control-Allow-Origin"], "*")
        ...
        self.assertIn(b"Contenuto non disponibile sul dispositivo", offline_body)
        ...
        self.assertEqual(asset_manifest["offline"], {"path": "offline.html"})
        self.assertIn("/", {record["url"] for record in asset_manifest["precache"]})
        self.assertIn("/offline.html", {record["url"] for record in asset_manifest["precache"]})
