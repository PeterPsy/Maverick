...
export function useChatAppController({
  ...
  const presentation = useChatControllerPresentation({
    ...
    handleSend,
    handleStopTurn,
    handleConfigureDeviceUse: deviceUse.configure,
    handleRefreshDeviceUse: deviceUse.refresh,
    handleRequestDeviceUsePermission: deviceUse.requestPermission,
    handleSelectDeviceUseMode: deviceUse.selectMode,
    hasLoadedHistory,
    isBootstrapping,
    isHistoryLoading,
