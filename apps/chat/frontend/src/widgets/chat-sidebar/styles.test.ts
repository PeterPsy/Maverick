...
describe("chat sidebar search", () => {
  ...
  it("keeps source badges compact as icon-only pills", () => {
    ...
    expect(styles).toMatch(/\.bs-chat-list__source-badges\s*{[\s\S]*flex:\s*0 0 28px;/);
    expect(styles).toMatch(/\.bs-chat-list__source-badges\s*{[\s\S]*width:\s*28px;/);
    expect(styles).toMatch(/\.bs-chat-list__source-badges\s*{[\s\S]*height:\s*28px;/);
    ...
    expect(styles).toMatch(/\.bs-chat-list__source-badge\s*{[\s\S]*inline-size:\s*28px;/);
    expect(styles).toMatch(/\.bs-chat-list__source-badge\s*{[\s\S]*block-size:\s*28px;/);
    expect(styles).toMatch(/\.bs-chat-list__source-badge\s*{[\s\S]*max-inline-size:\s*28px;/);
    expect(styles).toMatch(/\.bs-chat-list__source-badge\s*{[\s\S]*max-block-size:\s*28px;/);
    expect(styles).toMatch(/\.bs-chat-list__source-badge\s*{[\s\S]*width:\s*28px;/);
    expect(styles).toMatch(/\.bs-chat-list__source-badge\s*{[\s\S]*min-width:\s*28px;/);
    expect(styles).toMatch(/\.bs-chat-list__source-badge\s*{[\s\S]*height:\s*28px;/);
    expect(styles).toMatch(/\.bs-chat-list__source-badge\s*{[\s\S]*min-height:\s*28px;/);
    ...
    expect(styles).toMatch(/\.bs-chat-list__source-badge \.material-symbols-rounded\s*{[\s\S]*font-size:\s*1rem;/);
