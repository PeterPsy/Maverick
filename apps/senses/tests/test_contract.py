"""Contract tests for Senses Phase 1."""
...
class SensesContractTest(unittest.TestCase):
    def test_contract_declares_phase_1_surfaces(self) -> None:
    ...
    def test_contract_declares_phase_1_storage_dependencies(self) -> None:
        parsed = parse_app_contract_file(APP_ROOT)
