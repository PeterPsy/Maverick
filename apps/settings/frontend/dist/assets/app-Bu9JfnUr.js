import{s as ce,D as $e,a as ke}from"./pages-BZUBskpf.js";async function g(e,t={}){const s=await fetch(e,{credentials:"same-origin",headers:{"Content-Type":"application/json",...t.headers||{}},...t}),n=await s.json();if(!s.ok)throw new Error(n.detail||n.error||`Request failed ${s.status}`);return n}async function Se(){return(await g("/api/admin/users")).items}async function Ee(){return(await g("/api/admin/workspaces")).items}async function Pe(){return(await g("/api/admin/workspace-apps")).items}function ae(e,t=""){return typeof e=="string"?e:t}function Ae(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function Ce(e){if(!e||typeof e!="object"||Array.isArray(e))return null;const t=e,s=t.kind==="image"||t.kind==="glyph"?t.kind:null;return s&&typeof t.value=="string"?{kind:s,value:t.value}:null}function Ie(e){const t=e&&typeof e=="object"&&!Array.isArray(e)?e:{},s=ae(t.app_id);return{app_id:s,name:ae(t.name,s||"Unnamed app"),views:Ae(t.views),logo:Ce(t.logo)}}async function Re(){return((await g("/api/apps")).items||[]).map(Ie).filter(t=>t.app_id)}function Le(e){const t=new URLSearchParams({consumer_app_id:e});return g(`/api/apps/dependencies?${t.toString()}`)}function Me(e,t,s){return g("/api/apps/dependencies",{method:"POST",body:JSON.stringify({consumer_app_id:e,alias:t,provider_app_ids:s})})}function ee(){return g("/api/settings/platform")}function Ue(e){return g("/api/providers/active",{method:"POST",body:JSON.stringify(e)})}function He(e,t="settings_runtime_sessions_cleared"){return g("/api/settings/runtime-sessions/clear",{method:"POST",body:JSON.stringify({session_ids:e,reason:t})})}function De(){return g("/api/auth/logout",{method:"POST"})}function Te(e){return g("/api/admin/persistence/migrations/dry-run",{method:"POST",body:JSON.stringify(e)})}function Ne(e){return g("/api/admin/persistence/migrations/apply",{method:"POST",body:JSON.stringify(e)})}function Oe(e){return g("/api/admin/users",{method:"POST",body:JSON.stringify(e)})}function je(e,t){return g(`/api/admin/users/${encodeURIComponent(e)}`,{method:"PATCH",body:JSON.stringify(t)})}function Be(e,t){return g(`/api/admin/users/${encodeURIComponent(e)}/password`,{method:"POST",body:JSON.stringify({password:t})})}function Fe(e){return g(`/api/admin/users/${encodeURIComponent(e)}`,{method:"DELETE"})}function qe(e,t){return g(`/api/admin/users/${encodeURIComponent(e)}/workspaces`,{method:"PUT",body:JSON.stringify({memberships:t})})}function We(e){return g(`/api/admin/workspace-apps/${encodeURIComponent(e.workspace_id)}/${encodeURIComponent(e.app_id)}`,{method:"POST",body:JSON.stringify({source_id:e.source_id,enabled:!0})})}function Je(e,t){return g(`/api/admin/workspace-apps/${encodeURIComponent(e.workspace_id)}/${encodeURIComponent(e.app_id)}`,{method:"PATCH",body:JSON.stringify({status:t?"enabled":"disabled"})})}function Ke(e){return g(`/api/admin/workspace-apps/${encodeURIComponent(e.workspace_id)}/${encodeURIComponent(e.app_id)}`,{method:"DELETE",body:JSON.stringify({})})}function X(e){const t=e?.provider.active_provider,s=e?.provider.model_settings,n=s?.selected_model_id||t?.default_model_family||"",a=te(e).find(o=>o.model_id===n)||null;return{modelId:n,reasoningEffort:s?.selected_reasoning_effort||pe(a)}}function te(e){const t=e?.provider.active_provider,s=e?.provider.model_settings,n=s?.selected_model_id||t?.default_model_family||"",a=Q(s?.available_models).length?Q(s?.available_models):Q(t?.model_options);return(a.length?a:n?[Ve(n,s?.selected_reasoning_effort||"")]:[]).map(ze)}function pe(e){return e?.default_reasoning_effort||e?.supported_reasoning_efforts[0]?.effort||""}function Q(e){return(e||[]).filter(t=>t.model_id)}function ze(e){return e.supported_reasoning_efforts.length||!e.default_reasoning_effort?e:{...e,supported_reasoning_efforts:[{effort:e.default_reasoning_effort,label:e.default_reasoning_effort,description:null}]}}function Ve(e,t){return{model_id:e,label:e,description:null,default_reasoning_effort:t||null,supported_reasoning_efforts:t?[{effort:t,label:t,description:null}]:[]}}const Ge=new Set(["created","running","stopping"]);function Qe(){return{cleanupError:"",clearingAllRuntime:!1,cleaningSessionIds:new Set,draftModelId:"",draftReasoningEffort:"",isSavingProvider:!1,providerError:""}}function se(e,t){const{modelId:s,reasoningEffort:n}=X(t);e.draftModelId=s,e.draftReasoningEffort=n}function Xe(e,t,s){const n=te(t).find(a=>a.model_id===s)||null;e.draftModelId=s,e.draftReasoningEffort=pe(n),e.providerError=""}function Ye(e,t){if(!e)return`<section class="settings-card settings-platform">
    ...
    </section>`;const s=e.provider.active_provider,n=st(e),a=n.filter(C=>Ge.has(C.status)),o=e.runtime.cleanup_allowed??!1,i=e.runtime.cleanup_scope||"none",l=te(e),u=X(e).modelId,h=X(e).reasoningEffort,M=(l.find(C=>C.model_id===t.draftModelId)||l[0]||null)?.supported_reasoning_efforts||[],D=!!(s&&t.draftModelId&&!t.isSavingProvider&&(t.draftModelId!==u||t.draftReasoningEffort!==h));return`<section class="settings-card settings-platform">
    ...
    <label class="settings-platform-field">
      ...
      <select id="settings-provider-model" ${!e.length||n.isSavingProvider?"disabled":""}>
        ${e.map(a=>`<option value="${Y(a.model_id)}" ${a.model_id===n.draftModelId?"selected":""}>${b(a.label||a.model_id)}</option>`).join("")}
      </select>
    </label>
    <label class="settings-platform-field">
      <span>Reasoning</span>
      <select id="settings-provider-reasoning" ${!t.length||n.isSavingProvider?"disabled":""}>
        ${t.map(a=>`<option value="${Y(a.effort)}" ${a.effort===n.draftReasoningEffort?"selected":""}>${b(a.label||a.effort)}</option>`).join("")}
      </select>
    </label>
    ...
    <button type="button" class="settings-secondary" data-runtime-clear="${Y(e.session_id)}" ${!t||s.clearingAllRuntime||n?"disabled":""}>
      <span class="material-symbols-rounded" aria-hidden="true">${n?"sync":"delete_sweep"}</span>
      ${n?"Cleaning":"Clean"}
    </button>
  </div>`}function st(e){return e.runtime.all_sessions||e.runtime.sessions||[]}function b(e){return e.replace(/[&<>"']/g,t=>t==="&"?"&amp;":t==="<"?"&lt;":t===">"?"&gt;":t==='"'?"&quot;":"&#39;")}function Y(e){return b(e)}const nt=5,at=4,it=4,rt=3,ot=2,lt=4;function dt(e){return`<section class="settings-loading-skeleton" role="status" aria-label="Settings content is loading">
