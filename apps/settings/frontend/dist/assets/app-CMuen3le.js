import{s as ue,D as Ie,a as Ce}from"./pages-BZUBskpf.js";async function g(e,t={}){const s=await fetch(e,{credentials:"same-origin",headers:{"Content-Type":"application/json",...t.headers||{}},...t}),n=await s.json();if(!s.ok)throw new Error(n.detail||n.error||`Request failed ${s.status}`);return n}async function He(){return(await g("/api/admin/users")).items}async function Me(){return(await g("/api/admin/workspaces")).items}async function Re(){return(await g("/api/admin/workspace-apps")).items}function ie(e,t=""){return typeof e=="string"?e:t}function De(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function Le(e){if(!e||typeof e!="object"||Array.isArray(e))return null;const t=e,s=t.kind==="image"||t.kind==="glyph"?t.kind:null;return s&&typeof t.value=="string"?{kind:s,value:t.value}:null}function Ue(e){const t=e&&typeof e=="object"&&!Array.isArray(e)?e:{},s=ie(t.app_id);return{app_id:s,name:ie(t.name,s||"Unnamed app"),views:De(t.views),logo:Le(t.logo)}}async function Te(){return((await g("/api/apps")).items||[]).map(Ue).filter(t=>t.app_id)}function Ne(e){const t=new URLSearchParams({consumer_app_id:e});return g(`/api/apps/dependencies?${t.toString()}`)}function Oe(e,t,s){return g("/api/apps/dependencies",{method:"POST",body:JSON.stringify({consumer_app_id:e,alias:t,provider_app_ids:s})})}function Q(){return g("/api/settings/platform")}function Be(e){return g("/api/providers/active",{method:"POST",body:JSON.stringify(e)})}function je(e){return g("/api/providers/hosted/selection",{method:"POST",body:JSON.stringify(e)})}function Fe(e,t="settings_runtime_sessions_cleared"){return g("/api/settings/runtime-sessions/clear",{method:"POST",body:JSON.stringify({session_ids:e,reason:t})})}function qe(){return g("/api/auth/logout",{method:"POST"})}function We(e){return g("/api/admin/persistence/migrations/dry-run",{method:"POST",body:JSON.stringify(e)})}function Je(e){return g("/api/admin/persistence/migrations/apply",{method:"POST",body:JSON.stringify(e)})}function Ke(e){return g("/api/admin/users",{method:"POST",body:JSON.stringify(e)})}function ze(e,t){return g(`/api/admin/users/${encodeURIComponent(e)}`,{method:"PATCH",body:JSON.stringify(t)})}function Ve(e,t){return g(`/api/admin/users/${encodeURIComponent(e)}/password`,{method:"POST",body:JSON.stringify({password:t})})}function Ge(e){return g(`/api/admin/users/${encodeURIComponent(e)}`,{method:"DELETE"})}function Qe(e,t){return g(`/api/admin/users/${encodeURIComponent(e)}/workspaces`,{method:"PUT",body:JSON.stringify({memberships:t})})}function Xe(e){return g(`/api/admin/workspace-apps/${encodeURIComponent(e.workspace_id)}/${encodeURIComponent(e.app_id)}`,{method:"POST",body:JSON.stringify({source_id:e.source_id,enabled:!0})})}function Ye(e,t){return g(`/api/admin/workspace-apps/${encodeURIComponent(e.workspace_id)}/${encodeURIComponent(e.app_id)}`,{method:"PATCH",body:JSON.stringify({status:t?"enabled":"disabled"})})}function Ze(e){return g(`/api/admin/workspace-apps/${encodeURIComponent(e.workspace_id)}/${encodeURIComponent(e.app_id)}`,{method:"DELETE",body:JSON.stringify({})})}function x(e){const t=e?.provider.active_provider,s=e?.provider.model_settings;return fe(t,s,se(e))}function se(e){const t=e?.provider.active_provider,s=e?.provider.model_settings;return ve(t,s)}function ge(e){const t=e?.provider.hosted_text?.active_provider||null,s=e?.provider.hosted_text?.model_settings||null;return fe(t,s,me(e))}function me(e){const t=e?.provider.hosted_text?.active_provider||null,s=e?.provider.hosted_text?.model_settings||null;return ve(t,s)}function fe(e,t,s){const n=t?.selected_model_id||e?.default_model_family||"",a=s.find(o=>o.model_id===n)||null;return{modelId:n,reasoningEffort:t?.selected_reasoning_effort||_e(a)}}function ve(e,t){const s=t?.selected_model_id||e?.default_model_family||"",n=Z(t?.available_models).length?Z(t?.available_models):Z(e?.model_options);return(n.length?n:s?[et(s,t?.selected_reasoning_effort||"")]:[]).map(xe)}function _e(e){return e?.default_reasoning_effort||e?.supported_reasoning_efforts[0]?.effort||""}function Z(e){return(e||[]).filter(t=>t.model_id)}function xe(e){return e.supported_reasoning_efforts.length||!e.default_reasoning_effort?e:{...e,supported_reasoning_efforts:[{effort:e.default_reasoning_effort,label:e.default_reasoning_effort,description:null}]}}function et(e,t){return{model_id:e,label:e,description:null,default_reasoning_effort:t||null,supported_reasoning_efforts:t?[{effort:t,label:t,description:null}]:[]}}const tt=new Set(["created","running","stopping"]);function st(){return{cleanupError:"",clearingAllRuntime:!1,cleaningSessionIds:new Set,draftModelId:"",draftReasoningEffort:"",hostedDraftModelId:"",hostedProviderError:"",isSavingHostedProvider:!1,isSavingProvider:!1,providerError:""}}function X(e,t){const{modelId:s,reasoningEffort:n}=x(t),{modelId:a}=ge(t);e.draftModelId=s,e.draftReasoningEffort=n,e.hostedDraftModelId=a}function nt(e,t,s){const n=se(t).find(a=>a.model_id===s)||null;e.draftModelId=s,e.draftReasoningEffort=_e(n),e.providerError=""}function at(e,t){e.hostedDraftModelId=t,e.hostedProviderError=""}function it(e,t){if(!e)return`<section class="settings-card settings-platform">
    ...
    </section>`;const s=e.provider.active_provider,n=e.provider.hosted_text?.active_provider||null,a=pt(e),o=a.filter(m=>tt.has(m.status)),i=e.runtime.cleanup_allowed??!1,l=e.runtime.cleanup_scope||"none",u=se(e),y=me(e),S=x(e).modelId,I=x(e).reasoningEffort,R=ge(e).modelId,j=(u.find(m=>m.model_id===t.draftModelId)||u[0]||null)?.supported_reasoning_efforts||[],F=!!(s&&t.draftModelId&&!t.isSavingProvider&&(t.draftModelId!==S||t.draftReasoningEffort!==I)),d=!!(n&&t.hostedDraftModelId&&!t.isSavingHostedProvider&&t.hostedDraftModelId!==R);return`<section class="settings-card settings-platform">
    ...
    <div class="settings-platform-grid">
      ...
      <article class="settings-platform-tile settings-platform-provider">
        ...
        <div>
          ...
          <p>${f(S||"model")} · ${f(I||"reasoning")} · Codex tools/filesystem/MCP · ${o.length} active / ${a.length} in scope</p>
        </div>
      </article>
      <article class="settings-platform-tile settings-platform-provider">
        ...
        <div>
          ...
          <h3>${f(n?.label||"No hosted text provider")}</h3>
          <p>${f(R||"model not selected")} · plain hosted chat only · runtime engine remains Codex</p>
        </div>
      </article>
    </div>
    ...
    <label class="settings-platform-field">
      ...
      <select id="settings-provider-model" ${!e.length||n.isSavingProvider?"disabled":""}>
        ${e.map(a=>`<option value="${q(a.model_id)}" ${a.model_id===n.draftModelId?"selected":""}>${f(a.label||a.model_id)}</option>`).join("")}
      </select>
    </label>
    <label class="settings-platform-field">
      <span>Reasoning</span>
      <select id="settings-provider-reasoning" ${!t.length||n.isSavingProvider?"disabled":""}>
        ${t.map(a=>`<option value="${q(a.effort)}" ${a.effort===n.draftReasoningEffort?"selected":""}>${f(a.label||a.effort)}</option>`).join("")}
      </select>
    </label>
    ...
    <label class="settings-platform-field settings-platform-field-wide">
      ...
      <select id="settings-hosted-provider-model" ${!n||!e.length||s.isSavingHostedProvider?"disabled":""}>
        ${e.map(a=>`<option value="${q(a.model_id)}" ${a.model_id===s.hostedDraftModelId?"selected":""}>${f(a.label||a.model_id)}</option>`).join("")}
      </select>
    </label>
  ...
  </div>`}function pt(e){return e.runtime.all_sessions||e.runtime.sessions||[]}function f(e){return e.replace(/[&<>"']/g,t=>t==="&"?"&amp;":t==="<"?"&lt;":t===">"?"&gt;":t==='"'?"&quot;":"&#39;")}function q(e){return f(e)}const ut=5,gt=4,mt=4,ft=3,vt=2,_t=4;function ht(e){return`<section class="settings-loading-skeleton" role="status" aria-label="Settings content is loading">
    ...
    ${yt(e)}
  </section>`}function yt(e){return e.id==="workspace-access"?$t():e.id==="workspace-apps"?wt():e.id==="platform-settings"?kt():e.id==="persistence"?St():bt()}function bt(){return`${J()}
  ...
  </span>`}function p(e){return`<span class="settings-loading-skeleton__line settings-loading-skeleton__line--${e}"></span>`}function b(e){return`<span class="settings-loading-skeleton__block settings-loading-skeleton__block--${e}"></span>`}function L(e){return`<span class="settings-loading-skeleton__icon settings-loading-skeleton__icon--${e}"></span>`}function E(e,t){return Array.from({length:e},t).join("")}function Rt({publishChanged:e,render:t,setNotice:s}){let n=[],a=[],o="",i=[],l="",u=!1,y=new Set;function S(){return{appRegistry:n,dependencies:a,error:o,isLoading:u,loadErrors:i,savingKeys:y}}function I(){n=[],a=[],o="",i=[],l=""}function R(){l=""}async function B(d,m,k=!1){if(!(!d||u)&&!(!k&&l===d)){u=!0,o="",i=[],t();try{const[_,c]=await Promise.all([Te(),F(d,m)]);n=_,a=c,l=d}catch(_){a=[],l="",o=_ instanceof Error?_.message:"Unable to load app links."}finally{u=!1,t()}}}async function j(d,m,k){const _=Dt(d,m);y=new Set([...y,_]),t();try{const c=await Oe(d,m,k);a=a.map(D=>D.consumer_app_id===d?c:D),e(d,c),s({tone:"success",message:"App link updated."})}finally{const c=new Set(y);c.delete(_),y=c,t()}}async function F(d,m){const k=m.filter(c=>c.workspace_id===d&&c.status==="enabled"),_=await Promise.all(k.map(async c=>{try{return{app:c,payload:await Ne(c.app_id)}}catch(D){return{app:c,error:D instanceof Error?D.message:"Unable to load app links."}}}));return i=_.filter(c=>"error"in c).map(c=>({app_id:c.app.app_id,message:c.error,name:c.app.name||c.app.app_id})),_.filter(c=>"payload"in c&&c.payload.dependencies.length>0).map(c=>c.payload).sort((c,D)=>c.consumer_app_id.localeCompare(D.consumer_app_id))}return{ensureLoaded:B,invalidate:R,reset:I,saveDependencySelection:j,viewState:S}}function Dt(e,t){return`${e}:${t}`}function r(e){return e.replace(/[&<>"']/g,t=>t==="&"?"&amp;":t==="<"?"&lt;":t===">"?"&gt;":t==='"'?"&quot;":"&#39;")}function v(e){return r(e)}function O(e){return`<section class="settings-card settings-page-settings">
  ...
  </section>`}function Lt({appRegistry:e,dependencies:t,error:s,isLoading:n,loadErrors:a,page:o,savingKeys:i,workspaceApps:l}){return`${O(o)}
    ...
    ${t.candidates.length?`<div class="settings-app-link-candidates">
            ${t.candidates.map(l=>{const u=o.includes(l.app_id),y=t.cardinality==="many"?"checkbox":"radio",S=`dependency:${e}:${t.alias}`,I=ne(s,l.app_id);return`<label class="settings-app-link-candidate ${u?"is-selected":""}">
                <input
                  ${u?"checked":""}
                  ${a?"disabled":""}
    ...
    ${s?`<div class="settings-profile-row">
        ...
        </div>`:'<section class="settings-card"><h2>No users</h2></section>'}`}function ls({page:e,selectedUser:t,users:s,workspaces:n}){return`${O(e)}
    ${we(s,t)}
    ...
    <label class="settings-platform-field">
      ...
      </label>`}).join("")}function cs({page:e,workspaceApps:t,workspaces:s}){return`${O(e)}
  ...
  </div>`}function gs(e){return e.status!=="enabled"?"hide_source":{agents:"smart_toy","app-store":"storefront","base-shell":"dashboard",browser:"language",calendar:"calendar_month",chat:"forum",checklist:"checklist",crm:"contacts","developer-kit":"developer_board","docs-studio":"description","document-generator":"description","dynamic-views":"dashboard_customize","gmail-app":"mail",mail:"mail",memory:"database","maverick-monitor":"monitor_heart",settings:"admin_panel_settings",skills:"school",speech:"record_voice_over",storage:"cloud",vault:"key","website-studio":"web_asset"}[e.app_id]||"apps"}let C=[],V=[],W=[],te=null,P=null,w=st();const ke=Object.fromEntries(new URLSearchParams(window.location.search).entries());let G=ue(ke)||Ie,A=Pe(ke),U=!0,T="",$=null,de="",ce="";const ae=Qt({getPersistence:()=>te,render:()=>h(),requestPersistenceStatusQuiet:hs,setNotice:e=>{$=e},setPersistence:e=>{te=e}}),H=Rt({publishChanged:Ms,render:()=>h(),setNotice:e=>{$=e}});function Se(){return C.find(e=>e.user_id===A)||C[0]}function Pe(e){const t=K(e.user_id)||K(e.selected_user_id)||K(e.id);if(t)return t;const s=K(e.app_page),n=/^users\/([^/?#]+)$/.exec(s);if(!n?.[1])return"";try{return decodeURIComponent(n[1])}catch{return n[1]}}function K(e){return typeof e=="string"?e.trim():""}function ms(e){const t=ue(e),s=Pe(e);let n=!1;t&&t!==G&&(G=t,n=!0),s&&s!==A&&(A=s,T="",n=!0),n&&((C.length||U)&&h(),t==="app-links"&&Ee())}function fs(e){e.id===de||window.parent===window||(de=e.id,window.parent.postMessage({type:"maverick.app.selection-changed",owner_app_id:"settings",selection:{page_id:e.id}},window.location.origin))}function vs(e){!e||e.user_id===ce||window.parent===window||(ce=e.user_id,window.parent.postMessage({type:"maverick.app.selection-changed",owner_app_id:"settings",selection:{user_id:e.user_id}},window.location.origin))}function Y(){window.parent!==window&&window.parent.postMessage({type:"maverick.app.data-changed",owner_app_id:"settings",resource:"users"},window.location.origin)}async function _s(){try{return await g("/api/admin/persistence")}catch(e){return $={tone:"error",message:e instanceof Error?e.message:"Persistence API unavailable"},null}}async function hs(){try{return await g("/api/admin/persistence")}catch{return null}}async function ys(){try{return await Q()}catch{return null}}async function M(){U=!0,h();try{const[e,t,s,n,a]=await Promise.all([He(),Me(),Re(),_s(),ys()]),o=P?.workspace.workspace_id||"",i=a?.workspace.workspace_id||"";C=e,V=t,W=s,te=n,P=a,o!==i&&H.reset(),X(w,P),(!A||!C.some(l=>l.user_id===A))&&(A=C[0]?.user_id||"")}finally{U=!1}h(),G==="app-links"&&Ee()}async function Ee(e=!1){const t=P?.workspace.workspace_id||"";await H.ensureLoaded(t,W,e)}async function bs(e){const t=new FormData(e);A=(await Ke({username:String(t.get("username")||""),password:String(t.get("password")||""),display_name:String(t.get("display_name")||""),email:String(t.get("email")||""),platform_role:String(t.get("platform_role")||"member")})).user_id,e.reset(),await M(),Y()}async function $s(e,t){const s=new FormData(e);await ze(t.user_id,{display_name:String(s.get("display_name")||""),email:String(s.get("email")||""),platform_role:String(s.get("platform_role")||"member"),account_type:String(s.get("account_type")||"standard"),is_active:s.get("is_active")==="on"}),await M(),Y()}async function ws(e,t){const s=new FormData(e),n=String(s.get("password")||""),a=String(s.get("password_confirmation")||"");if(n!==a)throw new Error("Passwords do not match");await Ve(t.user_id,n),e.reset(),$={tone:"success",message:"Password updated."},h()}async function ks(e){const t=e.display_name||e.username;if(T!==e.user_id){T=e.user_id,$={tone:"info",message:`Press Delete user again to confirm permanent removal of ${t}.`},h();return}await Ge(e.user_id),A="",T="",$={tone:"success",message:`${t} deleted.`},await M(),Y()}async function Ss(e){const t=V.map(s=>{const n=document.querySelector(`[data-workspace-enabled="${s.workspace_id}"]`),a=document.querySelector(`[data-workspace-role="${s.workspace_id}"]`);return n?.checked?{workspace_id:s.workspace_id,role:a?.value||"member"}:null}).filter(s=>!!s);await Qe(e.user_id,t),await M(),Y()}async function Ps(e){await Xe(e),H.invalidate(),await M()}async function Es(e,t){await Ye(e,t),H.invalidate(),await M()}async function As(e){await Ze(e),H.invalidate(),await M()}async function Is(e,t,s){await H.saveDependencySelection(e,t,s)}async function Cs(e){const t=(e||[]).filter(Boolean);w.cleanupError="",t.length?t.forEach(s=>w.cleaningSessionIds.add(s)):w.clearingAllRuntime=!0,h();try{const s=await Fe(t.length?t:void 0);Hs(s),P=await Q(),X(w,P),$={tone:"success",message:t.length?"Runtime session cleaned.":"Runtime sessions cleaned."}}catch(s){w.cleanupError=s instanceof Error?s.message:"Unable to clean runtime sessions."}finally{t.forEach(s=>w.cleaningSessionIds.delete(s)),w.clearingAllRuntime=!1,h()}}function Hs(e){e.deleted_threads<=0||window.parent===window||(window.parent.postMessage({type:"maverick.app.data-changed",owner_app_id:"chat",resource:"threads"},window.location.origin),e.deleted_thread_ids.forEach(t=>{window.parent.postMessage({type:"maverick.app.data-changed",owner_app_id:"chat",resource:"threads",deleted_thread_id:t},window.location.origin)}))}function Ms(e,t){window.parent!==window&&window.parent.postMessage({type:"maverick.app.dependencies-changed",app_id:e,status:t.status},window.location.origin)}async function Rs(){if(window.parent&&window.parent!==window){window.parent.postMessage({type:"maverick.shell.logout"},window.location.origin);return}await qe(),window.location.href="/"}function Ds(e,t){if(e.id==="users")return os({page:e,pendingDeleteUserId:T,selectedUser:t,users:C});if(e.id==="workspace-access")return ls({page:e,selectedUser:t,users:C,workspaces:V});if(e.id==="workspace-apps")return cs({page:e,workspaceApps:W,workspaces:V});if(e.id==="app-links"){const s=H.viewState();return Lt({appRegistry:s.appRegistry,dependencies:s.dependencies,error:s.error,isLoading:s.isLoading,loadErrors:s.loadErrors,page:e,savingKeys:s.savingKeys,workspaceApps:W})}return e.id==="platform-settings"?Ls(e):Yt(e,ae.viewState())}function Ls(e){return`${O(e)}
    ${it(P,w)}`}function h(){const e=document.getElementById("app"),t=U?void 0:Se(),s=Ce(G);e&&(e.innerHTML=`<main class="settings-shell">
    <section class="settings-main">
      <div class="settings-content">
        ${U?ht(s):`<header class="detail-header">
          <div class="detail-title-block">
            <h2>${r(s.title)}</h2>
            <span class="detail-title-separator" aria-hidden="true"></span>
            <p>${r(s.summary)}</p>
    ...
    ${Zt(ae.viewState())}
  </main>`,Us(),fs(s),U||vs(t))}function Us(){Jt({clearRuntimeSessionsFromPanel:Cs,createUser:bs,deleteSelectedUser:ks,dismissNotice:()=>{$=null,h()},installWorkspaceApp:Ps,logoutFromSettings:Rs,onHostedProviderModelChanged:e=>{at(w,e),h()},onProviderModelChanged:e=>{nt(w,P,e),h()},onProviderReasoningChanged:e=>{w.draftReasoningEffort=e,w.providerError="",h()},persistenceController:ae,render:h,resetSelectedUserPassword:ws,saveDependencySelection:Is,saveHostedProviderSettingsFromPanel:()=>rs(pe()),saveProviderSettingsFromPanel:()=>is(pe()),selectedUser:Se,selectUser:e=>{A=e,T="",h()},setWorkspaceAppStatus:Es,showError:Ae,uninstallWorkspaceApp:As,updateMemberships:Ss,updateSelectedUser:$s,workspaceApps:()=>W,appDependencies:()=>H.viewState().dependencies})}function pe(){return{render:h,setNotice:e=>{$=e},setSettings:e=>{P=e},settings:P,state:w}}function Ae(e){$={tone:"error",message:e instanceof Error?e.message:"Unexpected error"},h()}function Ts(){return $?`<div class="settings-notice settings-notice-${$.tone}">
  ...
  </div>`:""}window.addEventListener("message",e=>{if(e.origin!==window.location.origin||!e.data||typeof e.data!="object")return;const t=e.data;t.type==="maverick.app.navigate"&&(!t.app_id||t.app_id==="settings")&&ms(t.params||{})});window.parent?.postMessage({type:"maverick.app.ready",app_id:"settings"},window.location.origin);M().catch(Ae);
