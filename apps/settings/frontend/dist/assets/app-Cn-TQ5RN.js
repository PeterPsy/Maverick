import{s as pe,D as ke,a as Se}from"./pages-BZUBskpf.js";async function g(e,t={}){const s=await fetch(e,{credentials:"same-origin",headers:{"Content-Type":"application/json",...t.headers||{}},...t}),n=await s.json();if(!s.ok)throw new Error(n.detail||n.error||`Request failed ${s.status}`);return n}async function Pe(){return(await g("/api/admin/users")).items}async function Ee(){return(await g("/api/admin/workspaces")).items}async function Ae(){return(await g("/api/admin/workspace-apps")).items}function ie(e,t=""){return typeof e=="string"?e:t}function Ce(e){return Array.isArray(e)?e.filter(t=>typeof t=="string"):[]}function Ie(e){if(!e||typeof e!="object"||Array.isArray(e))return null;const t=e,s=t.kind==="image"||t.kind==="glyph"?t.kind:null;return s&&typeof t.value=="string"?{kind:s,value:t.value}:null}function Re(e){const t=e&&typeof e=="object"&&!Array.isArray(e)?e:{},s=ie(t.app_id);return{app_id:s,name:ie(t.name,s||"Unnamed app"),views:Ce(t.views),logo:Ie(t.logo)}}async function Le(){return((await g("/api/apps")).items||[]).map(Re).filter(t=>t.app_id)}function Me(e){const t=new URLSearchParams({consumer_app_id:e});return g(`/api/apps/dependencies?${t.toString()}`)}function Ue(e,t,s){return g("/api/apps/dependencies",{method:"POST",body:JSON.stringify({consumer_app_id:e,alias:t,provider_app_ids:s})})}function ee(){return g("/api/settings/platform")}function He(e){return g("/api/providers/active",{method:"POST",body:JSON.stringify(e)})}function De(e,t="settings_runtime_sessions_cleared"){return g("/api/settings/runtime-sessions/clear",{method:"POST",body:JSON.stringify({session_ids:e,reason:t})})}function Te(){return g("/api/auth/logout",{method:"POST"})}function Ne(e){return g("/api/admin/persistence/migrations/dry-run",{method:"POST",body:JSON.stringify(e)})}function Oe(e){return g("/api/admin/persistence/migrations/apply",{method:"POST",body:JSON.stringify(e)})}function je(e){return g("/api/admin/users",{method:"POST",body:JSON.stringify(e)})}function Be(e,t){return g(`/api/admin/users/${encodeURIComponent(e)}`,{method:"PATCH",body:JSON.stringify(t)})}function Fe(e,t){return g(`/api/admin/users/${encodeURIComponent(e)}/password`,{method:"POST",body:JSON.stringify({password:t})})}function qe(e){return g(`/api/admin/users/${encodeURIComponent(e)}`,{method:"DELETE"})}function We(e,t){return g(`/api/admin/users/${encodeURIComponent(e)}/workspaces`,{method:"PUT",body:JSON.stringify({memberships:t})})}function Je(e){return g(`/api/admin/workspace-apps/${encodeURIComponent(e.workspace_id)}/${encodeURIComponent(e.app_id)}`,{method:"POST",body:JSON.stringify({source_id:e.source_id,enabled:!0})})}function Ke(e,t){return g(`/api/admin/workspace-apps/${encodeURIComponent(e.workspace_id)}/${encodeURIComponent(e.app_id)}`,{method:"PATCH",body:JSON.stringify({status:t?"enabled":"disabled"})})}function ze(e){return g(`/api/admin/workspace-apps/${encodeURIComponent(e.workspace_id)}/${encodeURIComponent(e.app_id)}`,{method:"DELETE",body:JSON.stringify({})})}function Y(e){const t=e?.provider.active_provider,s=e?.provider.model_settings,n=s?.selected_model_id||t?.default_model_family||"",a=te(e).find(l=>l.model_id===n)||null;return{modelId:n,reasoningEffort:s?.selected_reasoning_effort||ue(a)}}function te(e){const t=e?.provider.active_provider,s=e?.provider.model_settings,n=s?.selected_model_id||t?.default_model_family||"",a=X(s?.available_models).length?X(s?.available_models):X(t?.model_options);return(a.length?a:n?[Ge(n,s?.selected_reasoning_effort||"")]:[]).map(Ve)}function ue(e){return e?.default_reasoning_effort||e?.supported_reasoning_efforts[0]?.effort||""}function X(e){return(e||[]).filter(t=>t.model_id)}function Ve(e){return e.supported_reasoning_efforts.length||!e.default_reasoning_effort?e:{...e,supported_reasoning_efforts:[{effort:e.default_reasoning_effort,label:e.default_reasoning_effort,description:null}]}}function Ge(e,t){return{model_id:e,label:e,description:null,default_reasoning_effort:t||null,supported_reasoning_efforts:t?[{effort:t,label:t,description:null}]:[]}}const Qe=new Set(["created","running","stopping"]);function Xe(){return{cleanupError:"",clearingAllRuntime:!1,cleaningSessionIds:new Set,draftModelId:"",draftReasoningEffort:"",isSavingProvider:!1,providerError:""}}function se(e,t){const{modelId:s,reasoningEffort:n}=Y(t);e.draftModelId=s,e.draftReasoningEffort=n}function Ye(e,t,s){const n=te(t).find(a=>a.model_id===s)||null;e.draftModelId=s,e.draftReasoningEffort=ue(n),e.providerError=""}function Ze(e,t){if(!e)return`<section class="settings-card settings-platform">
    ...
    ${w("button")}
  </span>`}function $t(){return`<span class="settings-loading-skeleton__adapter-card">
    ${H("row")}
    <span class="settings-loading-skeleton__copy-stack">
      ${p("row-title")}
      ${p("row-copy-wide")}
  ...
  </div>`}let I=[],K=[],B=[],x=null,S=null,m=Xe();const he=Object.fromEntries(new URLSearchParams(window.location.search).entries());let z=pe(he)||ke,E=be(he),T=!0,N="",$=null,de="",ce="";const ae=Ft({getPersistence:()=>x,render:()=>_(),requestPersistenceStatusQuiet:os,setNotice:e=>{$=e},setPersistence:e=>{x=e}}),R=St({publishChanged:ws,render:()=>_(),setNotice:e=>{$=e}});function ye(){return I.find(e=>e.user_id===E)||I[0]}function be(e){const t=q(e.user_id)||q(e.selected_user_id)||q(e.id);if(t)return t;const s=q(e.app_page),n=/^users\/([^/?#]+)$/.exec(s);if(!n?.[1])return"";try{return decodeURIComponent(n[1])}catch{return n[1]}}function q(e){return typeof e=="string"?e.trim():""}function ns(e){const t=pe(e),s=be(e);let n=!1;t&&t!==z&&(z=t,n=!0),s&&s!==E&&(E=s,N="",n=!0),n&&((I.length||T)&&_(),t==="app-links"&&we())}function as(e){e.id===de||window.parent===window||(de=e.id,window.parent.postMessage({type:"maverick.app.selection-changed",owner_app_id:"settings",selection:{page_id:e.id}},window.location.origin))}function is(e){!e||e.user_id===ce||window.parent===window||(ce=e.user_id,window.parent.postMessage({type:"maverick.app.selection-changed",owner_app_id:"settings",selection:{user_id:e.user_id}},window.location.origin))}function V(){window.parent!==window&&window.parent.postMessage({type:"maverick.app.data-changed",owner_app_id:"settings",resource:"users"},window.location.origin)}async function rs(){try{return await g("/api/admin/persistence")}catch(e){return $={tone:"error",message:e instanceof Error?e.message:"Persistence API unavailable"},null}}async function os(){try{return await g("/api/admin/persistence")}catch{return null}}async function ls(){try{return await ee()}catch{return null}}async function L(){T=!0,_();try{const[e,t,s,n,a]=await Promise.all([Pe(),Ee(),Ae(),rs(),ls()]),l=S?.workspace.workspace_id||"",i=a?.workspace.workspace_id||"";I=e,K=t,B=s,x=n,S=a,l!==i&&R.reset(),se(m,S),(!E||!I.some(o=>o.user_id===E))&&(E=I[0]?.user_id||"")}finally{T=!1}_(),z==="app-links"&&we()}async function we(e=!1){const t=S?.workspace.workspace_id||"";await R.ensureLoaded(t,B,e)}async function ds(e){const t=new FormData(e);E=(await je({username:String(t.get("username")||""),password:String(t.get("password")||""),display_name:String(t.get("display_name")||""),email:String(t.get("email")||""),platform_role:String(t.get("platform_role")||"member")})).user_id,e.reset(),await L(),V()}async function cs(e,t){const s=new FormData(e);await Be(t.user_id,{display_name:String(s.get("display_name")||""),email:String(s.get("email")||""),platform_role:String(s.get("platform_role")||"member"),account_type:String(s.get("account_type")||"standard"),is_active:s.get("is_active")==="on"}),await L(),V()}async function ps(e,t){const s=new FormData(e),n=String(s.get("password")||""),a=String(s.get("password_confirmation")||"");if(n!==a)throw new Error("Passwords do not match");await Fe(t.user_id,n),e.reset(),$={tone:"success",message:"Password updated."},_()}async function us(e){const t=e.display_name||e.username;if(N!==e.user_id){N=e.user_id,$={tone:"info",message:`Press Delete user again to confirm permanent removal of ${t}.`},_();return}await qe(e.user_id),E="",N="",$={tone:"success",message:`${t} deleted.`},await L(),V()}async function gs(e){const t=K.map(s=>{const n=document.querySelector(`[data-workspace-enabled="${s.workspace_id}"]`),a=document.querySelector(`[data-workspace-role="${s.workspace_id}"]`);return n?.checked?{workspace_id:s.workspace_id,role:a?.value||"member"}:null}).filter(s=>!!s);await We(e.user_id,t),await L(),V()}async function ms(e){await Je(e),R.invalidate(),await L()}async function fs(e,t){await Ke(e,t),R.invalidate(),await L()}async function _s(e){await ze(e),R.invalidate(),await L()}async function vs(e,t,s){await R.saveDependencySelection(e,t,s)}async function hs(){const e=S?.provider.active_provider?.provider_id;if(!e||!m.draftModelId){m.providerError="Provider not loaded.",_();return}m.isSavingProvider=!0,m.providerError="",_();try{await He({provider_id:e,model_id:m.draftModelId,model_reasoning_effort:m.draftReasoningEffort||null}),S=await ee(),se(m,S),$={tone:"success",message:"Provider settings updated."}}catch(t){m.providerError=t instanceof Error?t.message:"Unable to update provider settings."}finally{m.isSavingProvider=!1,_()}}async function ys(e){const t=(e||[]).filter(Boolean);m.cleanupError="",t.length?t.forEach(s=>m.cleaningSessionIds.add(s)):m.clearingAllRuntime=!0,_();try{const s=await De(t.length?t:void 0);bs(s),S=await ee(),se(m,S),$={tone:"success",message:t.length?"Runtime session cleaned.":"Runtime sessions cleaned."}}catch(s){m.cleanupError=s instanceof Error?s.message:"Unable to clean runtime sessions."}finally{t.forEach(s=>m.cleaningSessionIds.delete(s)),m.clearingAllRuntime=!1,_()}}function bs(e){e.deleted_threads<=0||window.parent===window||(window.parent.postMessage({type:"maverick.app.data-changed",owner_app_id:"chat",resource:"threads"},window.location.origin),e.deleted_thread_ids.forEach(t=>{window.parent.postMessage({type:"maverick.app.data-changed",owner_app_id:"chat",resource:"threads",deleted_thread_id:t},window.location.origin)}))}function ws(e,t){window.parent!==window&&window.parent.postMessage({type:"maverick.app.dependencies-changed",app_id:e,status:t.status},window.location.origin)}async function $s(){if(window.parent&&window.parent!==window){window.parent.postMessage({type:"maverick.shell.logout"},window.location.origin);return}await Te(),window.location.href="/"}function ks(e,t){if(e.id==="users")return Yt({page:e,pendingDeleteUserId:N,selectedUser:t,users:I});if(e.id==="workspace-access")return Zt({page:e,selectedUser:t,users:I,workspaces:K});if(e.id==="workspace-apps")return es({page:e,workspaceApps:B,workspaces:K});if(e.id==="app-links"){const s=R.viewState();return Et({appRegistry:s.appRegistry,dependencies:s.dependencies,error:s.error,isLoading:s.isLoading,loadErrors:s.loadErrors,page:e,savingKeys:s.savingKeys,workspaceApps:B})}return e.id==="platform-settings"?Ss(e):Wt(e,ae.viewState())}function Ss(e){return`${j(e)}
    ...
    ${Jt(ae.viewState())}
  </main>`,Ps(),as(s),T||is(t))}function Ps(){Tt({clearRuntimeSessionsFromPanel:ys,createUser:ds,deleteSelectedUser:us,dismissNotice:()=>{$=null,_()},installWorkspaceApp:ms,logoutFromSettings:$s,onProviderModelChanged:e=>{Ye(m,S,e),_()},onProviderReasoningChanged:e=>{m.draftReasoningEffort=e,m.providerError="",_()},persistenceController:ae,render:_,resetSelectedUserPassword:ps,saveDependencySelection:vs,saveProviderSettingsFromPanel:hs,selectedUser:ye,selectUser:e=>{E=e,N="",_()},setWorkspaceAppStatus:fs,showError:$e,uninstallWorkspaceApp:_s,updateMemberships:gs,updateSelectedUser:cs,workspaceApps:()=>B,appDependencies:()=>R.viewState().dependencies})}function $e(e){$={tone:"error",message:e instanceof Error?e.message:"Unexpected error"},_()}function Es(){return $?`<div class="settings-notice settings-notice-${$.tone}">
  ...
  </div>`:""}window.addEventListener("message",e=>{if(e.origin!==window.location.origin||!e.data||typeof e.data!="object")return;const t=e.data;t.type==="maverick.app.navigate"&&(!t.app_id||t.app_id==="settings")&&ns(t.params||{})});window.parent?.postMessage({type:"maverick.app.ready",app_id:"settings"},window.location.origin);L().catch($e);
