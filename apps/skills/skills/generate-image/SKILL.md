---
name: generate-image
description: Create an image with the image generation tool, save it into the active workspace with a suitable filename, and verify it through Gallery.
---
...
7. Verify the saved workspace artifact through official Gallery app surfaces when inspection or confirmation is needed.
...
- Prefer Gallery app CLI or MCP surfaces for inspection, metadata lookup, rename, or confirmation of generated files.
