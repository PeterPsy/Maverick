...
- The file-preview chat widget renders the file body as one neutral Chat-style document box, posts height updates for taller previews, keeps iframe scrolling hidden, and opens Storage with the selected file when the box is clicked.
