"""Store contracts and document adapters for observability-domain records."""
...
class DocumentCollection(Protocol):
    """Minimal collection protocol used by observability stores."""
...
class ObservabilityCollections:
    """Collection bundle for observability persistence."""

    events: DocumentCollection
    audit: DocumentCollection
    metrics: DocumentCollection


class ObservabilityDocumentStore:
    """Persist observability-domain records in document collections."""
