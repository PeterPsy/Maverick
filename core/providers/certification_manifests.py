...
_SHARED_FIXTURE_TESTS = (
    ...
    "tests.unit.runtime_tools.test_attachment_read_fencing",
    ...
    "tests.unit.runtime_tools.test_full_workspace_security_contract",
    ...
    "tests.unit.runtime_tools.test_hosted_process_termination",
    ...
    "tests.unit.runtime_tools.test_hosted_workspace_real_data_effect_admission",
...
def _suite(
    *,
    ...
    return CertificationSuiteManifest(
        ...
        matrix_revision=(
            "2026-09-12-r65-openrouter-glm-workspace-instruction-redaction-tcb55"
        ),
...
ANTIGRAVITY_AGENTIC_CERTIFICATION_MANIFEST = CertificationSuiteManifest(
    ...
    matrix_revision="2026-09-12-r65-openrouter-glm-workspace-instruction-redaction-tcb55",
    tcb_manifest_id=CERTIFIED_EXECUTION_TCB.manifest_id,
    tcb_manifest_version=CERTIFIED_EXECUTION_TCB.manifest_version,
    tcb_structure_digest=CERTIFIED_EXECUTION_TCB.structure_digest,
    artifact_paths=CERTIFIED_EXECUTION_TCB.artifact_paths,
