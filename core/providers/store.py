...
class MongoCollection(Protocol):
    """Minimal collection protocol used by Mongo-backed provider stores."""
...
class ProviderCollections:
    """Mongo collection bundle for provider persistence."""

    definitions: MongoCollection
    bindings: MongoCollection
    selections: MongoCollection


class MongoProviderStore:
    """Persist provider-domain records in Mongo-style collections."""
