"""Store contracts and document adapters for recovery-domain records."""
...
class DocumentCollection(Protocol):
    """Minimal collection protocol used by recovery stores."""
...
class RecoveryCollections:
    """Collection bundle for recovery persistence."""

    failures: DocumentCollection
    intents: DocumentCollection
    health_results: DocumentCollection


class RecoveryDocumentStore:
    """Persist recovery-domain records in document collections."""
