...
def create_runtime_session(
    ...
    *,
    ...
    session = RuntimeSessionRecord(
        ...
        predecessor_session_id=_optional_text(predecessor_session_id),
        lineage_root_session_id=_optional_text(lineage_root_session_id),
        continuation_handoff_id=_optional_text(continuation_handoff_id),
