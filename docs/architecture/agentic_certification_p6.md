...
and Antigravity remain **NO-GO**. Until suite 67 is published and its binding is
...
That pass is historical. The current successor uses suite 67 / TCB 57 / hosted
adapter 59 / Google recipe 26 and profile 70 / OpenRouter GLM recipe 29 and
profile 6,
...
1. **Candidate identities and deterministic corpus:** hosted adapter 59,
   Google recipe 26/profile 70, OpenRouter GLM recipe 29/profile 6, suite 67,
   canonical TCB manifest 57, Antigravity adapter 5 / recipe 4, and active Codex revision
   15.
