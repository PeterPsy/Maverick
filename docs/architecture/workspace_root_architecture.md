...
The chat app may store thread metadata and reference a Maverick `runtime_session_id`, but it must not own the Codex provider thread id or reconstruct provider memory itself.
