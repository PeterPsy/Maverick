...
Suite 21 retains the P2 crash/pairing/outbox matrix and P3 finalization
...
`codex-baseline-v5`, mandatory commit-bound instruction digests and governed
...
- a synthetic-only provider credential delivered only to the operator-controlled
  live-probe worker;
- the dated suite-v21 matrix revision
  `2026-08-29-r21-p4-composite-atomic-closure-tcb11` declared by the provider certificate module;
...
version `21`, matrix revision
`2026-08-29-r21-p4-composite-atomic-closure-tcb11`, and the OpenRouter
manifest. The Google suite uses version `21` and the same matrix revision. The
