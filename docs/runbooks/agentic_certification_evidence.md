...
- a synthetic-only provider credential delivered only to the operator-controlled
  live-probe worker;
- the dated suite-v13 matrix revision `2026-08-28-r13-p3-review-tcb5` declared by the
...
version `13`, matrix revision `2026-08-28-r13-p3-review-tcb5`, and the OpenRouter
manifest. The Google suite uses version `13` and the same matrix revision. The
