"""Shared authentic native-Codex continuation certificate fixture."""
...
from tests.support.continuation import NOW


class NativeContinuationIdentityFixture:
    """Install an authentic historical projection for continuation tests."""
