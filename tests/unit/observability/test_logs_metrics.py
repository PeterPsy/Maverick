...
class TestLogsMetrics(ObservabilityTestBase):
    """Focused test slice."""
    ...
    def test_runtime_log_roots_and_retention_are_applied(self) -> None:
        ...
        roots = ensure_observability_roots(workspace_id="default", app_id="sample-app", start_path=repo_root)
        ...
        self.assertIn("/workspaces/default/logs/apps/sample-app/", record.log_path)
