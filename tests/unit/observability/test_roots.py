...
class TestObservabilityRoots(ObservabilityTestBase):
    """Focused test slice."""
    ...
    def test_workspace_export_manifest_excludes_logs_by_default(self) -> None:
        ...
        data_file = workspace_paths.data / "sample-app" / "db.sqlite"
        ...
        self.assertEqual([item.relative_path for item in manifest.files], ["data/sample-app/db.sqlite"])
