...
class CertificationPipelineTest(unittest.TestCase):
    ...
    def test_remote_manifests_bind_fixture_and_live_probe_commands(self) -> None:
        ...
        expected_manifest_digests = {
            "google-ai-studio": (
                "8263d6d670d024e5880fd2eb77b6e806f9127081a520f40ded8746e21baa8b46"
            ),
            "openrouter": (
                "e3ae1ad5806850ce11ea42b816f39a508850c64420c4590af37ca4c1e7ac292f"
            ),
        }
        for manifest in (
            GOOGLE_AGENTIC_CERTIFICATION_MANIFEST,
            ...
            with self.subTest(provider_id=manifest.provider_id):
                self.assertEqual(manifest.suite_version, "20")
                self.assertEqual(
