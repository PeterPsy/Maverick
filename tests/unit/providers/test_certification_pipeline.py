    ...
    def test_remote_manifests_bind_fixture_and_live_probe_commands(self) -> None:
        ...
        expected_command_digests = {
            ...
            ("openrouter", "fixture_contract"): (
                "bdbf3db67787d6a8333de55a54dde3c1cd7c23c6a9db0bc1ad94249a2805197c"
            ),
        ...
        expected_manifest_digests = {
            "google-ai-studio": (
                "d993ea64361c17f35065df55028ff4689215ee4f7e67fecff45a8fc4e56801c1"
            ),
            "openrouter": (
                "8b4d478c62227c434cdcac981989a9e4ad540e4cea883426b727a1176f4d7976"
            ),
        }
        for manifest in (
            GOOGLE_AGENTIC_CERTIFICATION_MANIFEST,
            ...
            with self.subTest(provider_id=manifest.provider_id):
                self.assertEqual(manifest.suite_version, "21")
                self.assertEqual(
