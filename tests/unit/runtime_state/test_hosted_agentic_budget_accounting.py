...
from core.runtime.hosted_agentic_models import HostedAgenticLoopError, HostedFinalizationPolicy


class HostedAgenticBudgetAccountingTest(unittest.TestCase):
    def setUp(self) -> None:
        self.policy = replace(
